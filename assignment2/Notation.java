...
public class Notation {
	 ...
	 */
	private static int operation(String op, String num1, String num2) {
		//parse both string variables to ints
		...
		try {
			for(char index : copy) {
				...
				//the operator to the stack
					...
					num2 = stack.pop();
					num1 = stack.pop();
					stack.push(Integer.toString(operation(Character.toString(index), num1, num2)));
				}
			}
