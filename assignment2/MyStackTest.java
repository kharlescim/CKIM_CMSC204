...
public class MyStackTest {
	...
	public void testPopStudent() {
		...
		try {
			assertTrue(doubleS.pop().equals(3.34));
			assertTrue(doubleS.pop().equals(6.62));
			assertTrue(doubleS.pop().equals(1.83));
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(3.792));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(9.103));
	...
	public void testToStringStudent() throws StackOverflowException{
		//Use the doubleQ for student tests
				assertEquals("1.836.623.34",doubleS.toString());
				doubleS.push(3.792);
				assertEquals("1.836.623.343.792",doubleS.toString());
				doubleS.push(9.103);
				assertEquals("1.836.623.343.7929.103", doubleS.toString());
	}
