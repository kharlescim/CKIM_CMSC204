...
public class MyQueueTest {
	...
	public void testDequeueStudent() {
		//Use the doubleQ for student tests
				try {
					assertEquals("2.5", doubleQ.dequeue().toString());
					assertEquals("3.9", doubleQ.dequeue().toString());
					assertEquals("8.3", doubleQ.dequeue().toString());
					//Queue is empty, next statement should cause QueueUnderFlowException
					doubleQ.dequeue();
					assertTrue("This should have caused an QueueUnderflowException", false);
				}
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(1.2));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(5.6));
	...
	public void testToStringStudent() throws QueueOverflowException{
		//Use the doubleQ for student tests
		assertEquals("2.53.98.3", doubleQ.toString());
		doubleQ.enqueue(1.2);
		assertEquals("2.53.98.31.2", doubleQ.toString());
		doubleQ.enqueue(5.6);
		assertEquals("2.53.98.31.25.6", doubleQ.toString());
}
